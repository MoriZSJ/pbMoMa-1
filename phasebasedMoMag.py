...
fpsForBandPass = 500 # use -1 for input video fps #筛选freq的范围:[0,fps/2] 
# low ideal filter
lowFreq = 10
# high ideal filter
highFreq = 20
# output video filename
vidFnameOut = vidFname + '-Mag%dIdeal-lo%.2f-hi%.2f-fps%d.avi' % (factor, lowFreq, highFreq,fpsForBandPass)
